 ...
 * @author jake swart
 */
public class CatalogArtifactTypesImpl implements CatalogArtifactTypesInf {

  private final CatalogArtifactTypesFormatInf formatInst;

  private CatalogArtifactTypesFormatEnum format = CatalogArtifactTypesFormatEnum.JSON;
  private Boolean pretty = Boolean.FALSE;

  public CatalogArtifactTypesImpl() {
    formatInst = new CatalogArtifactTypesFormatImpl(this);
  }
  ...
  private String formatEndpointUrlAsString(final List<String> urlOptions) {
    ...
    final String urlStr = String.format("%s/catalog/artifact-types%s%s", ScryFallApiConstants.BASE_API_URL, question,
        options);
    return urlStr;
  }
  ...
  /* Client options */
  public CatalogArtifactTypesFormatInf withFormat() {
    return formatInst;
  }

  public CatalogArtifactTypesInf withPretty() {
    this.pretty = Boolean.TRUE;
    return this;
  }

  /* Option implementation accessors into this class */
  public void setFormat(final CatalogArtifactTypesFormatEnum format) {
    this.format = format;
  }
  ...
  private List<String> from() {
    ...
    final List<String> params = new ArrayList<String>();
    if (format != CatalogArtifactTypesFormatEnum.JSON) {

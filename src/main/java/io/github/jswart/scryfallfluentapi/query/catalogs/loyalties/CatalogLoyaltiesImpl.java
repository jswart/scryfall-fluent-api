 ...
 * @author jake swart
 */
public class CatalogLoyaltiesImpl implements CatalogLoyaltiesInf {

  private final CatalogLoyaltiesFormatInf formatInst;

  private CatalogLoyaltiesFormatEnum format = CatalogLoyaltiesFormatEnum.JSON;
  private Boolean pretty = Boolean.FALSE;

  public CatalogLoyaltiesImpl() {
    formatInst = new CatalogLoyaltiesFormatImpl(this);
  }
  ...
  private String formatEndpointUrlAsString(final List<String> urlOptions) {
    ...
    final String urlStr = String.format("%s/catalog/loyalties%s%s", ScryFallApiConstants.BASE_API_URL, question,
        options);
    return urlStr;
  }
  ...
  /* Client options */
  public CatalogLoyaltiesFormatInf withFormat() {
    return formatInst;
  }

  public CatalogLoyaltiesInf withPretty() {
    this.pretty = Boolean.TRUE;
    return this;
  }

  /* Option implementation accessors into this class */
  public void setFormat(final CatalogLoyaltiesFormatEnum format) {
    this.format = format;
  }
  ...
  private List<String> from() {
    ...
    final List<String> params = new ArrayList<String>();
    if (format != CatalogLoyaltiesFormatEnum.JSON) {

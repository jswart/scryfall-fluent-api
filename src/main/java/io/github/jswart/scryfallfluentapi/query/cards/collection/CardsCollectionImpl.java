package io.github.jswart.scryfallfluentapi.query.cards.collection;
 ...
 * @author jake swart
 */
public class CardsCollectionImpl implements CardsCollectionInf {
  ...
  private String formatEndpointUrlAsString(final List<String> urlOptions) {
    ...
    final String urlStr = String.format("%s/cards/collection%s%s", ScryFallApiConstants.BASE_API_URL, question,
        options);
    return urlStr;
  }
  ...
  public CardsCollectionInf withPretty() {
